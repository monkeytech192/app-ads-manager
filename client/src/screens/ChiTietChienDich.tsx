...
const CampaignDetailScreen: React.FC<CampaignDetailScreenProps> = ({ onBack, campaign, onUpdateCampaignContext }) => {
  ...
  // ==================== UPDATE CAMPAIGN CONTEXT FOR GLOBAL AI CHAT ====================
  const buildCampaignContext = React.useCallback((): CampaignContext => {
    return {
      // Thông tin cơ bản
      campaignName: displayCampaign.title,
      status: displayCampaign.status,
